...
COPY complete/java/demo/gradle/ ./gradle/
COPY complete/java/demo/gradlew complete/java/demo/build.gradle complete/java/demo/settings.gradle ./
...
# Copy source code
COPY complete/java/demo/src ./src
